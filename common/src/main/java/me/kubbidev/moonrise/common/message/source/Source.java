 ...
 * <p>
 * This interface can be implemented for various messaging systems to provide a consistent way of sending messages,
 * where the {@link #sendMessage(Component)} method serves as the primary entry point for dispatching messages to a
 * recipient.
 */
public interface Source {
     ...
     * @return a {@code CompletableFuture} that completes with the resulting {@code Message} object once the message has
     ...
     *
     * @param embed the embed containing the structured message details such as title, content, fields, and other visual
     *              elements
     * @return a {@code CompletableFuture} that completes with the resulting {@code Message} object once the message has
     * been successfully sent
     */
