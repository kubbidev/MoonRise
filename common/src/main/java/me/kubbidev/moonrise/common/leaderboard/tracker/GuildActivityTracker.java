...
/**
 * The GuildActivityTracker class is responsible for managing and tracking user
 * activity in various guild channels.
 */
public final class GuildActivityTracker {
     ...
     * @param frozen A boolean value indicating whether the user should initially be marked as frozen
     ...
     *
     * Additionally, if the activity tracker corresponding to the channel becomes
     * empty after the removal, the tracker is invalidated and removed from the cache.
     *
     ...
     * @return The {@link MemberState} of the removed user if the user was present in the tracker,
     * or null if the user or channel was not found.
     */
     ...
     * <p>
     * This method iterates through all {@link ActivityTracker} instances stored
     * in the `activityTrackers` cache and applies the specified frozen state
     ...
     * @param frozen A boolean indicating the new frozen state for the user.
     *               Set to {@code true} to mark the user as frozen, or {@code false} to unfreeze.
     */
