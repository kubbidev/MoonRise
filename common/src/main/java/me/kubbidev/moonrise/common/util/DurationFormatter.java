...
public class DurationFormatter {
    ...
    //   moonrise.duration.unit.years.plural={0} years
    //   moonrise.duration.unit.years.singular={0} year
    //   moonrise.duration.unit.years.short={0}y
    // ... and so on
    ...
    private TranslatableComponent formatPart(long amount, ChronoUnit unit) {
        ...
        String translationKey = "moonrise.duration.unit." + unit.name().toLowerCase(Locale.ROOT) + "." + format;
