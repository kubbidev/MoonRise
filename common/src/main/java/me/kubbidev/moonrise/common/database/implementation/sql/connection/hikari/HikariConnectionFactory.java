...
public abstract class HikariConnectionFactory implements ConnectionFactory {
    private final DatabaseCredentials configuration;
    private HikariDataSource hikari;

    public HikariConnectionFactory(DatabaseCredentials configuration) {
    ...
    public void init(MoonRisePlugin plugin) {
        ...
        config.setPoolName("moonrise-hikari");
    ...
    public Connection getConnection() throws SQLException {
        ...
        var connection = this.hikari.getConnection();
        if (connection == null) {
