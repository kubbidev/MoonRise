package me.kubbidev.moonrise.common.gateway;

import me.kubbidev.moonrise.common.gateway.command.InteractionManager;
import me.kubbidev.moonrise.common.gateway.listener.MemberListener;
import me.kubbidev.moonrise.common.gateway.listener.UserListener;
import me.kubbidev.moonrise.common.gateway.retriever.AbstractEntityRetriever;
...
public class GatewayClient extends AbstractEntityRetriever implements AutoCloseable {
    ...
    private void establishConnection(String token) {
        this.shardManager = DefaultShardManagerBuilder.createDefault(token)
                ...
                .addEventListeners(new MemberListener(this.plugin), new UserListener(this.plugin))
