package me.kubbidev.moonrise.common.dependencies.classloader;

import java.net.URL;
import java.net.URLClassLoader;

/**
 * A classloader "isolated" from the rest of the process.
 *
 * <p>Used to load specific MoonRise dependencies without causing conflicts
